...
public class Ex3 {
	...
	public static void mouseClicked(Point2D p) {
		...
		if(_mode.equals("next_click")){
			_map.drawRect(first_click, p, col);
		}
		...
		if(_mode.equals("next_click")){
			_map.drawSegment(first_click, p, col);
		}
		...
		if(_mode.equals("next_click")){
			_map.drawCircle(first_click, p.distance(first_click), col);
			//_mode = "None";
		}
